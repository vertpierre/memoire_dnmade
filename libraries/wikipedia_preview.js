!((e, i) => {
  ...
  ((e) => {
    ...
    return (
      ...
      (n.t = (e, i) => {
        ...
        if (
          ...
          for (var a in e) n.d(r, a, ((i) => e[i]).bind(null, a));
        return r;
      }),
      (n.n = (e) => {
    ...
    (e, i, n) => {
      ...
      var g,
        c = ((g = []), (e, i) => ((g[e] = i), g.filter(Boolean).join("\n")));
      function u(e, i, n, r) {
        var a = n
          ? ""
          : r.media
    ...
    (e, i, n) => {
      ...
      e.exports = (() => {
        ...
        var $ = () => ("undefined" == typeof window ? null : window),
          F = (e, i) => {
            if (
        ...
        return (function e() {
          ...
          var me = W,
            ...
            ti = (e) => {
              (ri && ri === e) ||
                ((e && "object" === (void 0 === e ? "undefined" : J(e))) ||
                  (e = {}),
                (e = I(e)),
                ...
                ($e =
                  "ADD_URI_SAFE_ATTR" in e
                    ? M(I(Fe), e.ADD_URI_SAFE_ATTR)
                    : Fe),
                (Je =
                  "ADD_DATA_URI_TAGS" in e
                    ? M(I(Ue), e.ADD_DATA_URI_TAGS)
                    : Ue),
                ...
                (Ke = Ke =
                  -1 === ei.indexOf(e.PARSER_MEDIA_TYPE)
                    ? ii
                    : e.PARSER_MEDIA_TYPE),
                (ni = "application/xhtml+xml" === Ke ? (e) => e : f),
                Te && (Se = !1),
                Ce && (Ee = !0),
                Ze &&
                  ((be = M({}, [].concat(U(z)))),
                ...
                e.FORBID_CONTENTS &&
                  (Be === He && (Be = I(Be)), M(Be, e.FORBID_CONTENTS)),
                Ge && (be["#text"] = !0),
          ...
          var gi = (e) => {
              var i = ne(e);
              (i && i.tagName) ||
                (i = { namespaceURI: Qe, tagName: "template" });
              var n = f(e.tagName),
                r = f(i.tagName);
              if (e.namespaceURI === _e)
                return i.namespaceURI === Qe
                  ? "svg" === n
                  : i.namespaceURI === qe
                    ? "svg" === n && ("annotation-xml" === r || oi[r])
                    : Boolean(si[n]);
            ...
            hi = (e) => {
              var i = void 0;
              if ((yi("beforeSanitizeElements", e, null), fi(e)))
                return ci(e), !0;
              if (w(e.nodeName, /[\u0080-\uFFFF]/)) return ci(e), !0;
              var r = ni(e.nodeName);
              if (
                (yi("uponSanitizeElement", e, { tagName: r, allowedTags: be }),
                !wi(e.firstElementChild) &&
                  (!wi(e.content) || !wi(e.content.firstElementChild)) &&
                  k(/<[/\w]/g, e.innerHTML) &&
                  k(/<[/\w]/g, e.textContent))
              )
                return ci(e), !0;
              if ("select" === r && k(/<template/i, e.innerHTML))
                return ci(e), !0;
              if (!be[r] || je[r]) {
                if (Ge && !Be[r]) {
            ...
            vi = (e, i, n) => {
              if (Re && ("id" === i || "name" === i) && (n in a || n in ai))
                return !1;
              if (Se && !Ne[i] && k(we, i));
              else if (Ae && k(ye, i));
              else {
                ...
                for (t = o.length; t--; ) {
                  ...
                  if (
                    ...
                    if (k(/\/>/i, r)) ui(d, e);
                      ...
                      if (vi(c, a, r))
                        try {
                          g ? e.setAttributeNS(g, d, r) : e.setAttribute(d, r),
                            p(n.removed);
                        } catch (e) {}
                    }
                }
            ...
            bi = function e(i) {
              ...
              for (yi("beforeSanitizeShadowDOM", i, null); (n = r.nextNode()); )
                yi("uponSanitizeShadowNode", n, null),
                  hi(n) || (n.content instanceof o && e(n.content), ki(n));
          ...
          return (
            (n.sanitize = (e, a) => {
              ...
              if (
                ...
                (1 ===
                  (l = (t = pi("\x3c!----\x3e")).ownerDocument.importNode(
                    e,
                    !0,
                  )).nodeType &&
                  "BODY" === l.nodeName) ||
                ...
                if (!Ee && !Te && !De && -1 === e.indexOf("<"))
                  return ae && We ? ae.createHTML(e) : e;
              ...
              for (var u = mi(Ye ? e : t); (d = u.nextNode()); )
                (3 === d.nodeType && d === g) ||
                  hi(d) ||
                  (d.content instanceof o && bi(d.content), ki(d), (g = d));
              if (((g = null), Ye)) return e;
              if (Ee) {
                if (Ce)
                  for (c = de.call(t.ownerDocument); t.firstChild; )
              ...
              return (
                Te && ((p = y(p, me, " ")), (p = y(p, fe, " "))),
                ae && We ? ae.createHTML(p) : p
              );
            }),
            (n.setConfig = (e) => {
              ti(e), (ze = !0);
    ...
    (e, i, n) => {
      ...
      function c(e) {
        for (var i = 1; i < arguments.length; i++) {
          ...
          i % 2
            ? g(Object(n), !0).forEach((i) => {
                u(e, i, n[i]);
              })
            : Object.getOwnPropertyDescriptors
              ? Object.defineProperties(e, Object.getOwnPropertyDescriptors(n))
              : g(Object(n)).forEach((i) => {
      ...
      var p =
        ...
        y = (e, i) => (
          ...
          "https://".concat(e, ".wikipedia.org/w/api.php") +
            "?" +
            Object.keys(i)
              .map((e) => "".concat(e, "=").concat(encodeURIComponent(i[e])))
              .join("&")
        ),
        h = (e) => e.replace(/https:\/\/(.*?)\./, (e) => e + "m."),
        v = (e) => {
          var i,
        ...
        k = (e) => l.a.sanitize(e),
        b = () => ({ height: window.innerHeight, width: window.innerWidth }),
        x = () => "wprov=wppw1" + (p ? "t" : ""),
        M = function (e, i, n) {
          var r =
          ...
          r(
            ...
            (i) => {
              ...
              return {
                ...
                description: s,
                license: o && o.value,
                filePage: h(n[0].descriptionshorturl),
                bestFitImageUrl: d,
              };
            },
            n,
      ...
      function C(e, i) {
        return (C =
          Object.setPrototypeOf || ((e, i) => ((e.__proto__ = i), e)))(e, i);
      }
      var P = window.innerWidth,
        ...
        H = (e) => (e ? Number(e.slice(e.indexOf("scale") + 6, -1)) : 1),
        J = (e, i) => {
          var n = [
            ...
            "".concat(i, "-button"),
          ].find((i) => e.target.className.indexOf(i) > -1);
          return "touch" !== e.pointerType || n;
        },
        U = () => Z,
        $ = (e) => e.naturalHeight <= e.naturalWidth,
        F = () => G.length,
        q = (e, i) => {
          var n = (function () {
            var e =
              ...
              n = {},
              r = () =>
                e.clientY > i.naturalHeight && !$(i)
                  ? i.naturalHeight
                  : e.clientY;
            return (
              2 === G.length
                ? ((n.x = (G[0].clientX + G[1].clientX) / 2),
                  (n.y = (G[0].clientY + G[1].clientY) / 2))
                : ((n.x = e.clientX), (n.y = r())),
              n
            );
          })(i, e);
        ...
        _ = (e) => {
          e &&
            ((e.style.transition = R.imgOriginalTransition),
      ...
      var ee,
        ...
        ge = (e, i) => {
          ...
          return '\n\t\t<div class="'
            ...
            .concat(
              (le < 400 && o.length > 128) || (le > 400 && o.length > 142)
                ? '<div class="'.concat(se, '-item-caption-expand-cue"></div>')
                : "",
              "\n\t\t\t",
            )
            .concat(
              o
                ? '<div class="'
                    .concat(se, '-item-caption-text"><bdi>')
                    .concat(o, "</bdi></div>")
                : "",
              '\n\t\t</div>\n\t\t<div class="',
            )
            ...
            .concat(
              ((n = e.license),
              (r = ""),
              ["CC", "BY", "SA", "Fair", "Public"].forEach((e) => {
                n &&
                  -1 !== n.indexOf(e) &&
                  (r += '<div class="'
                    .concat(se, "-item-attribution-info-")
            ...
            .concat(
              a
                ? '<bdi class="'
                    .concat(se, '-item-attribution-info-author">')
                    .concat(a, "</bdi>")
                : "",
              "\n\t\t\t</div>\n\t\t\t",
            )
            ...
            r.addEventListener("load", () => {
              ...
              r.addEventListener("error", () => {
                ...
                m()) ||
                  ((i.querySelector(
                    ".".concat(se, "-item-loading-error-text"),
                  ).innerText = A(ee, "gallery-loading-error-offline")),
          ...
          a &&
            D(ee, ie[e].title, (n) => {
              ...
              t) ||
                ...
                a
                  .querySelector(".".concat(se, "-item-caption"))
        ...
        me = function () {
          ...
          l &&
            ...
            pe(te + 1, i),
            pe(te - 1, i)),
            (n.style["ltr" === oe ? "marginLeft" : "marginRight"] =
              -le * te + "px");
        },
        fe = () => {
          me(-1);
            ...
            J(n, se) ||
              (((e) => {
                ...
                if (i) {
                  ...
                  if (
                    ((R.imageRect.top = n.top),
                    (R.imageRect.bottom = n.bottom),
                    (R.imageRect.left = n.left),
                    (R.imageRect.right = n.right),
                    G.length < 1)
                  ) {
                  ...
                  : U()
                    ? ((e, i, n, r, a) => {
                        ...
                        if (t) {
                          ...
                          if (
                            ((u =
                              (R.imageRect.left < s && y) ||
                              (R.imageRect.right > d && !y)),
                            (p =
                              (R.imageRect.top < g && w) ||
                              (R.imageRect.bottom > c && !w)),
                            u && p)
                          )
                            (R.imageRect.top =
                              R.imageRect.top + (f - R.translateY)),
                              (R.imageRect.bottom =
                                R.imageRect.bottom + (f - R.translateY)),
                              (R.imageRect.left =
                                R.imageRect.left + (m - R.translateX)),
                              (R.imageRect.right =
                                R.imageRect.right + (m - R.translateX)),
                              (R.translateX = m),
                              (R.translateY = f),
                              (R.clientX = e.clientX),
                              (R.clientY = e.clientY),
                    ...
                    : ((e, i, n, r) => {
                        ...
                        (R.currentMarginLeft =
                          R.originalMarginLeft + a * ("ltr" === r ? 1 : -1)),
                          (i.style[n] = R.currentMarginLeft + "px"),
                          e.preventDefault();
                      })(r, e, i, oe));
            }),
              ...
              J(n, se) ||
                ...
                1 !== F() ||
                  ...
                  ((e, i, n, r, a) => {
                    ...
                    Math.abs(t / P) > 0.4 || (o <= 300 && Math.abs(t) > 5)
                      ? n(t > 0 ? 1 : -1)
                      : (i.style[r] = -P * a + "px");
                  })(0, e, me, i, te),
                X(n));
        ...
        ye = () => {
          ...
          me(0),
            ...
            e.addEventListener("click", (e) => {
              (e.target.className !== "".concat(se, "-item") &&
                ...
                (a
                  ...
                  : (a = setTimeout(() => {
                      (a = null),
                        ne
                          .querySelector(".wp-gallery-fullscreen")
                  ...
                  !(function (e, i, n, r) {
                    ...
                    a.insertAdjacentHTML("beforeend", he(n, r)),
                      a
                        ...
                        .insertAdjacentHTML("beforeend", de(e, i, n, r, a));
      ...
      var Me,
        ...
        Ze = (e, i, n, r) => {
          var a = "<span>".concat(
              A(i, "preview-disambiguation-message", n),
              "</span>",
            ),
            t = Ge(i, n, e);
      ...
      function Ue(e) {
            ...
            ? (function (e) {
                var i =
                  arguments.length > 1 && void 0 !== arguments[1]
                    ...
                    : window;
                Ie ||
                  ((Ie = i.document.createElement("div")).classList.add(
                    "wp-touch-popup",
                  ),
                ...
                var n = {},
                  r = (e) => {
                    (Ie.innerHTML = e),
                      ...
                      ze(i.document),
                      n.onShow && n.onShow(Ie);
                  },
                  a = () => {
                    n.onHide && n.onHide(Ie),
                      (Ie.style.visibility = "hidden"),
                      Oe(i.document);
                  },
                  t = () => {
            ...
            : (function (e) {
                var i =
                  arguments.length > 1 && void 0 !== arguments[1]
                    ...
                    : window;
                Me ||
                  ((Me = i.document.createElement("div")).classList.add(
                    "wp-popup",
                  ),
                ...
                var n = {},
                  r = () => {
                    n.onHide && n.onHide(Me),
                      (Me.style.visibility = "hidden"),
                      (Me.currentTargetElement = null);
                  },
                  a = (e, r, a) => {
                    Me.innerHTML = e;
                    var t =
                ...
                if (a === Ne && v.loading) {
                  if (((v.loading = !1), i))
                    (v.lang = s),
                      ...
                      "standard" === i.type
                        ? (v.show(We(s, i, p), o, d),
                          He(u, "onShow", [l, s, "standard"]))
                        : "disambiguation" === i.type &&
                          (v.show(Ze(p, s, i.title, i.dir), o, d),
                          He(u, "onShow", [l, s, "disambiguation"]));
                  else if (m())
                    v.show(Ye(p, s, l, g), o, d),
                      He(u, "onShow", [l, s, "error"]);
                  else {
                    v.show(Be(p, s, g), o, d),
                      He(u, "onShow", [l, s, "offline"]);
        ...
        v.subscribe(k),
          Array.prototype.forEach.call(n.querySelectorAll(a), (e) => {
            p
          ...
          y &&
            ...
            x.forEach((e, i) => {
              console.log(
                i + 1,
                "".concat(e.text, " -> ").concat(M(e.lang, e.title, p, !1)),
              );
            }),
            console.groupEnd(),
            s &&
