...
!((t, e) => {
  ...
  var r,
    ...
    p = {}.toString,
    v = (t) => p.call(t).slice(8, -1),
    g = "".split,
    b = c(() => !Object("z").propertyIsEnumerable(0))
      ? (t) => ("String" == v(t) ? g.call(t, "") : Object(t))
      : Object,
    y = (t) => {
    ...
    m = (t) => b(y(t)),
    x = (t) => ("object" == typeof t ? null !== t : "function" == typeof t),
    E = (t, e) => {
      if (!x(t)) return t;
      var r, i;
    ...
    C = l ? (t, e, r) => M.f(t, e, d(1, r)) : (t, e, r) => ((t[e] = r), t),
    W = (t, e) => {
      try {
        C(a, t, e);
      } catch (r) {
    ...
    j = e((t) => {
      ...
      (t.exports = (t, r) => e[t] || (e[t] = void 0 !== r ? r : {}))(
        "versions",
        [],
      ).push({
        version: "3.2.1",
  ...
  var K = {
    ...
    Z = a,
    tt = (t) => ("function" == typeof t ? t : void 0),
    et = function (t, e) {
    ...
    rt = Math.ceil,
    it = Math.floor,
    nt = (t) => (isNaN((t = +t)) ? 0 : (t > 0 ? it : rt)(t)),
    ot = Math.min,
    st = (t) => (t > 0 ? ot(nt(t), 9007199254740991) : 0),
    at = Math.max,
    ct = Math.min,
    lt = (t) => (e, r, i) => {
      var n,
    ...
    pt = {
      f: Object.getOwnPropertyNames || ((t) => ft(t, dt)),
    },
    ...
    xt = (mt.normalize = (t) => String(t).replace(yt, ".").toLowerCase()),
    Et = (mt.data = {}),
    wt = (mt.NATIVE = "N"),
    St = (mt.POLYFILL = "P"),
    Ot = mt,
    ...
    Lt = (t, e, r) => {
      ...
      switch (r) {
        ...
        case 1:
          return (r) => t.call(e, r);
        case 2:
          return (r, i) => t.call(e, r, i);
        case 3:
          return (r, i, n) => t.call(e, r, i, n);
      }
      return function () {
    ...
    zt = (t) => Object(y(t)),
    Rt = Array.isArray || ((t) => "Array" == v(t)),
    _t = !!Object.getOwnPropertySymbols && !c(() => !String(Symbol())),
    Mt = a.Symbol,
    Ct = j("wks"),
    Wt = (t) =>
  ...
  var Ze = (t, e, r) => {
    ...
    tr = !c(() => Object.isExtensible(Object.preventExtensions({}))),
    er = e((t) => {
      var e = M.f,
        r = F("meta"),
        i = 0,
        n = Object.isExtensible || (() => !0),
        o = (t) => {
        ...
        s = (t.exports = {
          ...
          onFreeze: (t) => (tr && s.REQUIRED && n(t) && !S(t, r) && o(t), t),
        });
      H[r] = !0;
    }),
  ...
  var hr = (t, e, r, i, n) => {
    ...
    br = Dt.findIndex,
    yr = 0,
    mr = (t) => t.frozen || (t.frozen = new xr()),
    xr = function () {
      this.entries = [];
    },
    Er = (t, e) => gr(t.entries, (t) => t[0] === e);
  xr.prototype = {
    get: function (t) {
      var e = Er(this, t);
      if (e) return e[1];
    ...
    delete: function (t) {
      var e = br(this.entries, (e) => e[0] === t);
      return ~e && this.entries.splice(e, 1), !!~e;
    },
  };
  var wr = {
      getConstructor: (t, e, r, i) => {
        var n = t((t, o) => {
            ar(t, n, e),
  ...
  function qr(t, e, r) {
    ...
    function b() {
      ...
      if (((i = arguments), (n = this), (c = t), r)) {
        if (void 0 === a)
          return ((t) => ((l = t), (a = setTimeout(v, e)), u ? d(t) : s))(c);
  ...
  function Yr(t) {
    ...
    if (
      ((t) =>
        "symbol" == typeof t ||
        (((t) => !!t && "object" == typeof t)(t) && Fr.call(t) == Mr))(t)
    )
      return _r;
    if ($r(t)) {
  ...
  function fi(t) {
    ...
    if (
      ((t) =>
        "symbol" == typeof t ||
        (((t) => !!t && "object" == typeof t)(t) && si.call(t) == Kr))(t)
    )
      return Qr;
    if (ui(t)) {
      var e = "function" == typeof t.valueOf ? t.valueOf() : t;
  ...
  function Di(t, e) {
    var r = ((t, e) => (null == t ? void 0 : t[e]))(t, e);
  ...
  var $i,
    ...
    Ui = (() => {
      ...
      return (
        ...
        (t.fromRect = (e) => new t(e.x, e.y, e.width, e.height)),
        t
      );
    })(),
    Qi = (t) => t instanceof SVGElement && "getBBox" in t,
    Ki = (t) => {
      if (Qi(t)) {
        var e = t.getBBox(),
          r = e.width,
    ...
    dn = (t) => {
      Hi.forEach((e) => {
        e.activeTargets.splice(0, e.activeTargets.length),
          ...
          e.observationTargets.forEach((r) => {
            r.isActive() &&
              (fn(r.target) > t
    ...
    pn = () => {
      var t,
        e = 0;
      for (dn(e); Hi.some((t) => t.activeTargets.length > 0); )
        (e = hn()), dn(e);
      return (
        Hi.some((t) => t.skippedTargets.length > 0) &&
    ...
    gn = (t) => {
      if (!$i) {
        ...
        new MutationObserver(() => vn.splice(0).forEach((t) => t())).observe(
          r,
          { characterData: !0 },
        ),
          ($i = () => {
    ...
    xn = (t) => (void 0 === t && (t = 0), Date.now() + t),
    En = !1,
    wn = new ((() => {
      function t() {
        (this.stopped = !0), (this.listener = () => this.schedule());
      }
      return (
          ...
          if ((void 0 === t && (t = 250), !En)) {
            ...
            (r = () => {
              ...
              try {
                ...
                r ? this.run(1e3) : t > 0 ? this.run(t) : this.start();
              }
            }),
              gn(() => {
        ...
        (t.prototype.observe = function () {
          var e = () =>
            this.observer && this.observer.observe(document.body, yn);
        ...
        (t.prototype.start = function () {
          this.stopped &&
            ...
            this.observe(),
            mn.forEach((e) => Zi.addEventListener(e, this.listener, !0)));
        }),
        (t.prototype.stop = function () {
          this.stopped ||
            (this.observer && this.observer.disconnect(),
            mn.forEach((e) => Zi.removeEventListener(e, this.listener, !0)),
            (this.stopped = !0));
        }),
        t
      );
      ...
      return (
        ...
        (t.disconnect = function (t) {
          ...
          r.observationTargets
            .slice()
            .forEach((r) => this.unobserve(t, r.target)),
            r.activeTargets.splice(0, r.activeTargets.length);
        }),
        t
      );
    ...
    zn = (() => {
      ...
      return (
        ...
        (t.toString = () => "function ResizeObserver () { [polyfill code] }"),
        t
      );
    })(),
    Rn = (t) => (e, r, i, n) => {
  ...
  (Vn || Xn) &&
    (Fn = function (t) {
      var e, r, i, n;
      return (
        Xn && (r = new RegExp("^" + this.source + "$(?!\\s)", Bn.call(this))),
        Vn && (e = this.lastIndex),
        (i = Dn.call(this, t)),
        Vn && i && (this.lastIndex = this.global ? i.index + i[0].length : e),
        Xn &&
          i &&
          i.length > 1 &&
        ...
        s =
          ...
          !c(() => {
            ...
            return (
              (r.exec = () => ((e = !0), null)),
              "split" === t &&
                ((r.constructor = {}), (r.constructor[qn] = () => r)),
              r[n](""),
              !e
            );
          });
  ...
  var io = (t) =>
    Array.prototype.reduce.call(
      ...
      (t, e) => {
        ...
        if (r) {
          var i = r[1].replace(/\W+(.)/g, (t, e) => e.toUpperCase());
          switch (e.value) {
            case "true":
              t[i] = !0;
              break;
      ...
      (this.onScroll = () => {
        ...
        (this.scrollX = () => {
          this.axis.x.isOverflowing &&
            (this.showScrollbar("x"), this.positionScrollbar("x")),
            (this.scrollXTicking = !1);
        }),
        (this.scrollY = () => {
          this.axis.y.isOverflowing &&
            (this.showScrollbar("y"), this.positionScrollbar("y")),
        ...
        (this.hideScrollbars = () => {
          (this.axis.x.track.rect =
            ...
            this.isWithinBounds(this.axis.y.track.rect) ||
              (this.axis.y.scrollbar.el.classList.remove(
                this.classNames.visible,
              ),
              (this.axis.y.isVisible = !1)),
            this.isWithinBounds(this.axis.x.track.rect) ||
              (this.axis.x.scrollbar.el.classList.remove(
                this.classNames.visible,
              ),
              (this.axis.x.isVisible = !1));
        }),
        (this.onPointerEvent = (t) => {
          ...
          (this.axis.x.track.rect =
            ...
            (this.axis.y.isOverflowing || this.axis.y.forceVisible) &&
              (r = this.isWithinBounds(this.axis.y.track.rect)),
            (e || r) &&
              (t.preventDefault(),
              t.stopPropagation(),
              "mousedown" === t.type &&
        ...
        (this.drag = (e) => {
          var r = this.axis[this.draggedAxis].track,
            n = r.rect[this.axis[this.draggedAxis].sizeAttr],
            o = this.axis[this.draggedAxis].scrollbar,
            s =
          ...
          var c =
            ((("y" === this.draggedAxis ? e.pageY : e.pageX) -
              r.rect[this.axis[this.draggedAxis].offsetAttr] -
              this.axis[this.draggedAxis].dragOffset) /
              (n - o.size)) *
            (s - a);
          "x" === this.draggedAxis &&
            ((c =
              this.isRtl && t.getRtlHelpers().isRtlScrollbarInverted
                ? c - (n + o.size)
                : c),
            (c =
              this.isRtl && t.getRtlHelpers().isRtlScrollingInverted ? -c : c)),
        ...
        (this.onEndDrag = (t) => {
          ...
          t.preventDefault(),
            ...
            (this.removePreventClickId = r.setTimeout(() => {
    ...
    return (
      ...
      (e.initListeners = function () {
        ...
        this.options.autoHide &&
          ...
          ["mousedown", "click", "dblclick"].forEach((e) => {
            this.el.addEventListener(e, this.onPointerEvent, !0);
          }),
      ...
      (e.removeListeners = function () {
        ...
        this.options.autoHide &&
          ...
          ["mousedown", "click", "dblclick"].forEach((e) => {
            this.el.removeEventListener(e, this.onPointerEvent, !0);
          }),
          ["touchstart", "touchend", "touchmove"].forEach((e) => {
      ...
      (e.findChild = (t, e) => {
        var r =
          ...
          t.msMatchesSelector;
        return Array.prototype.filter.call(t.children, (t) => r.call(t, e))[0];
      }),
      t
    );
  })();
  return (
    ...
    (lo.handleMutations = (t) => {
      t.forEach((t) => {
        Array.prototype.forEach.call(t.addedNodes, (t) => {
          1 === t.nodeType &&
          ...
          Array.prototype.forEach.call(t.removedNodes, (t) => {
            1 === t.nodeType &&
              ("init" === t.getAttribute("data-simplebar")
                ? lo.instances.has(t) &&
                  !document.documentElement.contains(t) &&
